  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created artwork as @artwork" do
        post :create, {:artwork => valid_attributes}, valid_session
        expect(assigns(:artwork)).to be_a(Artwork)
        expect(assigns(:artwork)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved artwork as @artwork" do
        post :create, {:artwork => invalid_attributes}, valid_session
        expect(assigns(:artwork)).to be_a_new(Artwork)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested artwork" do
        artwork = Artwork.create! valid_attributes
        put :update, {:id => artwork.to_param, :artwork => new_attributes}, valid_session
        artwork.reload
    ...
    describe "with invalid params" do
      it "assigns the artwork as @artwork" do
        artwork = Artwork.create! valid_attributes
        put :update, {:id => artwork.to_param, :artwork => invalid_attributes}, valid_session
        expect(assigns(:artwork)).to eq(artwork)
      end
